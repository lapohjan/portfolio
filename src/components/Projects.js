      ...
      return(
        <div className="projects-grid">
          ...
          <Card shadow={5} style={{minWidth: '300px', margin: '2rem', borderRadius: '10px'}}>
            <CardTitle style={{color: '#fff', textShadow:'1px 1px #000000', height: '220px', background: 'url(./music.jpg) top, center / cover'}} >Music From My Year</CardTitle>
            <CardText>
            ...
            <CardActions border>
            <a href="https://github.com/lapohjan/music-app/tree/dev-branch" target="__blank" rel="noopener noreferrer">
              <Button colored>GitHub</Button>
            </a>
            <a href="https://lauratellervo.fi/mymusic/" target="__blank" rel="noopener noreferrer">
          ...
          <Card shadow={5} style={{minWidth: '300px', margin: '2rem', borderRadius: '10px'}}>
            ...
            <CardActions border>
            <a href="https://github.com/lapohjan/social-network" target="__blank" rel="noopener noreferrer">
              <Button colored>GitHub</Button>
              </a>
              <a href="https://network-3c607.web.app/" target="__blank" rel="noopener noreferrer">
              <Button colored>Live Demo</Button>
              </a>
            </CardActions>
            <CardMenu style={{color: '#fff'}}>
          ...
          <Card shadow={5} style={{minWidth: '300px', maxWidth: '500px', margin: '2rem', borderRadius: '10px'}}>
            <CardTitle style={{color: '#fff', textShadow:'1px 1px #000000', height: '220px', background: 'url(./calendar.jpg) center / cover'}}>Advent calendar</CardTitle>
            <CardText>
              An advent calendar. Flipping cards, responsive design. A project I did following Thomas Weibenfalk's Youtube tutorial. My version has toy pics behind the doors instead of Christmas jokes.
            </CardText>
            <CardActions border>
            <a href="https://github.com/lapohjan/christmas-calendar" target="__blank" rel="noopener noreferrer">
              <Button colored>GitHub</Button>
              </a>
              <a href="https://www.lauratellervo.fi/calendar/" target="__blank" rel="noopener noreferrer">
              <Button colored>Live Demo</Button>
              </a>
            </CardActions>
            <CardMenu style={{color: '#fff'}}>
           ...
           {/* Project 4 */}
           <Card shadow={5} style={{minWidth: '300px', maxWidth: '500px', margin: '2rem', borderRadius: '10px'}}>
            <CardTitle style={{color: '#fff', textShadow:'1px 1px #000000', height: '220px', background: 'url(./nails.jpg) center/cover'}}>Total Recall Nails</CardTitle>
            <CardText>
            Color changing nails! This is my own just-for-fun project inspired by a 1990's movie Total Recall. Click on the wristwatch and then any nail you want to "paint". Done with React and RandomColor script. 
            </CardText>
            <CardActions border>
            <a href="https://github.com/lapohjan/total_recall_nails" target="__blank" rel="noopener noreferrer">
              <Button colored>GitHub</Button>
              </a>
              <a href="https://www.lauratellervo.fi/nails/" target="__blank" rel="noopener noreferrer">
              <Button colored>Live Demo</Button>
              </a>
            </CardActions>
            <CardMenu style={{color: '#fff'}}>
          ...
          <Card shadow={5} style={{minWidth: '300px', maxWidth: '500px', margin: '2rem', borderRadius: '10px'}}>
            ...
            <CardActions border>
            <a href="https://github.com/lapohjan/reactjs_sandbox/tree/master/5_task" target="__blank" rel="noopener noreferrer">
              <Button colored>GitHub</Button>
              </a>
              <a href="https://www.lauratellervo.fi/speedgame/" target="__blank" rel="noopener noreferrer">
              <Button colored>Live Demo</Button>
              </a>
            </CardActions>
            <CardMenu style={{color: '#fff'}}>
    ...
    return(
      <div className="projects-grid">
        ...
        <Card shadow={5} style={{minWidth: '300px', margin: '2rem', borderRadius: '10px'}}>
          ...
          <CardActions border>
          <a href="https://github.com/lapohjan/node-weather-website" target="__blank" rel="noopener noreferrer">
            <Button colored>GitHub</Button>
          </a>
          <a href="https://northern-light-weather.herokuapp.com/" target="__blank" rel="noopener noreferrer">
            <Button colored>Live Demo</Button>
            </a>
          </CardActions>
          <CardMenu style={{color: '#fff'}}>
        ...
        <Card shadow={5} style={{minWidth: '300px', margin: '2rem', borderRadius: '10px'}}>
          ...
          <CardActions border>
          <a href="https://github.com/lapohjan/ice-cream-app" target="__blank" rel="noopener noreferrer">
            <Button colored>GitHub</Button>
            </a>
            <a href="https://northern-light-ice-cream-app.herokuapp.com/" target="__blank" rel="noopener noreferrer">
            <Button colored>Live Demo</Button>
            </a>
          </CardActions>
          <CardMenu style={{color: '#fff'}}>
      ...
      return(
        <div className="projects-grid">
          ...
          <Card shadow={5} style={{minWidth: '300px', margin: '2rem', borderRadius: '10px'}}>
            ...
            <CardActions border>
            <a href="https://github.com/lapohjan/Mimmit_koodaa" target="__blank" rel="noopener noreferrer">
              <Button colored>GitHub</Button>
            </a>
            <a href="https://lauratellervo.fi/population/" target="__blank" rel="noopener noreferrer">
              <Button colored>Live Demo</Button>
              </a>
            </CardActions>
            <CardMenu style={{color: '#fff'}}>
